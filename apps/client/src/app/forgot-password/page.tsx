        ...
        <div className="relative z-10 flex flex-col justify-between p-16 w-full h-full text-surface-container-lowest">
          ...
          <div className="max-w-md">
            ...
            <p className="text-xl font-light leading-relaxed mb-10 opacity-90">
              Identity verification and secure credential restoration for the DentFlow clinical
              ecosystem.
            </p>
          </div>
          ...
          {status === 'success' ? (
            <div className="bg-primary-container/30 border border-primary/20 p-8 rounded-2xl space-y-6 animate-in zoom-in-95 duration-500">
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-on-surface-variant font-medium">
                  ...
                  <span className="text-primary font-bold">{email}</span> if it matches an existing
                  account.
                </p>
              </div>
              <Link
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center pt-2">
                <Link
                  href="/login"
                  className="text-sm font-bold text-primary hover:underline decoration-2 underline-offset-4 flex items-center justify-center gap-2"
                >
