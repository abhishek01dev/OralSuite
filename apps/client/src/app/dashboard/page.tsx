  ...
  const dashboardMetrics = [
    {
      ...
      value: formatCurrency(statsList.revenue.total),
      change: statsList.revenue.change,
      icon: 'payments',
    ...
    {
      label: 'New Patients',
      value: statsList.patients.total.toString(),
      change: statsList.patients.change,
      icon: 'person_add',
    ...
    },
    {
      ...
      value: statsList.appointments.total.toString(),
      change: statsList.appointments.change,
      icon: 'event_note',
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-8 p-8 rounded-[2rem] bg-gradient-to-br from-primary/5 to-tertiary-container/5 border border-tertiary-fixed-dim/20 backdrop-blur-xl flex items-center gap-8 relative overflow-hidden group">
          ...
          <div className="z-10 flex-1">
            <div className="flex items-center gap-2 mb-2">
              <span className="px-2 py-0.5 rounded bg-tertiary text-on-tertiary text-[10px] font-bold tracking-widest uppercase">
                Smart Insights
              </span>
            ...
            <h3 className="text-2xl font-bold font-headline mb-4">
              You have <span className="text-primary">3 High-Priority</span> Follow-ups needing
              attention.
            </h3>
            <div className="flex gap-6">
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm font-body font-medium">
                  Projected Revenue: <span className="text-secondary">+15% this month</span>
                </p>
              </div>
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-blue-500">clinical_notes</span>
                <p className="text-sm font-body font-medium">
                  Patient retention is at <span className="text-blue-600">94%</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="col-span-12 lg:col-span-4 grid grid-cols-1 gap-4">
          {dashboardMetrics.map((metric, i) => (
            <div
              key={i}
              className={`p-6 rounded-[1.5rem] bg-surface-container-lowest shadow-sm flex items-center justify-between group hover:shadow-md transition-all ${isLoading ? 'animate-pulse' : ''}`}
            >
              <div>
              ...
              <div
                className={`w-12 h-12 rounded-2xl ${metric.color} flex items-center justify-center ${metric.text} group-hover:scale-110 transition-transform`}
              >
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-sm text-on-surface-variant font-body">
                Manage and monitor daily clinical workflow.
              </p>
            </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-sm">
                {statsList.upcomingAppointments.length === 0 ? (
                  ...
                  statsList.upcomingAppointments.map((appt: Record<string, unknown>) => {
                    const patient = appt.patient as Record<string, string> | undefined;
                    const dentist = appt.dentist as Record<string, string> | undefined;
                    return (
                      <tr
                      ...
                      >
                        ...
                        <td className="py-5 font-medium text-on-surface">
                          {new Date(appt.startTime as string).toLocaleTimeString([], {
                            hour: '2-digit',
                            minute: '2-digit',
                          })}
                        </td>
                        <td className="py-5 text-on-surface-variant">
                          {(appt.treatmentType as string) || 'General Consultation'}
                        </td>
          ...
          <div className="space-y-8 relative">
            ...
            <div className="relative pl-10">
              ...
              <p className="text-xs text-on-surface-variant">
                Daily goals and emergency protocols reviewed.
              </p>
            </div>
            <div className="relative pl-10">
              ...
              <p className="text-xs text-on-surface-variant">
                Expecting crowns for Case #8210 and #8211.
              </p>
            </div>
            <div className="relative pl-10">
              ...
              <p className="text-xs text-on-surface-variant">
                Monthly stock check of anesthetics and resins.
              </p>
            </div>
          </div>
        </div>
