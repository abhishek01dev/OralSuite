...
// Default tenant ID — can be overridden via env var or subdomain detection
const DEFAULT_TENANT_ID = process.env['NEXT_PUBLIC_TENANT_ID'] ?? 'system';
      ...
      <section className="hidden lg:flex lg:w-5/12 relative overflow-hidden bg-on-surface">
        ...
        <div className="relative z-10 flex flex-col justify-between p-16 w-full h-full text-surface-container-lowest">
          ...
          <div className="max-w-md">
            <span className="inline-block px-4 py-1.5 mb-6 text-xs font-bold tracking-widest uppercase bg-white/20 backdrop-blur-md rounded-full border border-white/20">Welcome Back</span>
            <h2 className="font-headline text-5xl font-bold leading-tight mb-6 mt-2">
              The AI-First <br/>Dental OS
            </h2>
            <p className="text-xl font-light leading-relaxed mb-10 opacity-90">
              Precision diagnostics and practice management engineered for the next generation of clinical excellence.
            </p>
            
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/10">
              <p className="text-lg font-medium italic mb-4">"DentFlow saved us 15 hours a week on admin. My staff is happier, and I get to focus on actual surgery."</p>
              <div className="flex items-center gap-4">
                <img className="w-12 h-12 rounded-full border-2 border-white/20 object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBRWXeS7jhEpd944ypJvP9YpjpS6ArNP8ZQHBr7BkvUQxHmzMnezd9nB4v4s1oZrOw4hbnTrU0SQhLzUvQSjnjH6ZO0qyWEDckeo1UdAFWp3_XEoo96lmWAAO0gsqCvS_2ys-_MvHZGa-80UyFvrJ4v7qFD4A1lhc2pOL-v4_RwNawmf8EWcdTDi5HNYweAWceag9Y_80rm-1i9e6KUw0VJTob_iDv9YzC1vEDUUzK9hCoCS37vUX6lsAsSS1iPJXYi49M4W0CtMWVq" alt="Dr. Jensen" />
                <div>
      ...
      <section className="w-full lg:w-7/12 flex items-center justify-center p-8 relative">
        ...
        <div className="w-full max-w-md space-y-10 relative z-10">
          ...
          <div className="lg:hidden flex items-center gap-2 mb-12">
            ...
            <h1 className="font-headline text-2xl font-extrabold text-on-surface tracking-tight">DentFlow</h1>
          </div>

          <header>
            <h3 className="font-headline text-4xl font-bold text-on-surface mb-2 tracking-tight">Welcome back</h3>
            <p className="text-on-surface-variant text-lg">Enter your clinical credentials to continue.</p>
          </header>

          {/* SSO Options */}
          <div className="grid grid-cols-2 gap-4">
            <button type="button" className="flex items-center justify-center gap-3 px-4 py-3 bg-surface-container-lowest border border-outline-variant/30 rounded-lg hover:bg-surface-container-low transition-colors duration-200 group">
            ...
            <button type="button" className="flex items-center justify-center gap-3 px-4 py-3 bg-surface-container-lowest border border-outline-variant/30 rounded-lg hover:bg-surface-container-low transition-colors duration-200 group">
              <svg className="w-5 h-5" viewBox="0 0 23 23"><path d="M1 1h10v10H1z" fill="#f35325"></path><path d="M12 1h10v10H12z" fill="#81bc06"></path><path d="M1 12h10v10H1z" fill="#05a6f0"></path><path d="M12 12h10v10H12z" fill="#ffba08"></path></svg>
          ...
          <div className="relative flex items-center justify-center">
            ...
            <span className="relative px-4 bg-background text-xs font-semibold text-outline tracking-widest uppercase">or email</span>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Link href="/forgot-password" className="text-xs font-bold text-primary hover:text-primary-fixed-variant transition-colors">Forgot password?</Link>
              </div>
              <div className="relative">
            ...
            <div className="flex items-center gap-3">
              ...
              <label className="text-sm text-on-surface-variant font-medium select-none" htmlFor="remember">Remember this workstation for 30 days</label>
            </div>
          ...
          <footer className="pt-8 text-center">
            <p className="text-on-surface-variant text-sm">
              New practice? <Link className="text-primary font-bold hover:underline decoration-2 underline-offset-4 ml-1" href="/register">Schedule a briefing</Link>
            </p>
          </footer>
        </div>
      </section>
