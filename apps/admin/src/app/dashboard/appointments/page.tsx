...
const appointments = [
  { id: 'APT-001', time: '09:00 AM', patient: 'Sarah Mitchell', patientInitials: 'SM', clinic: 'North Peak Dental', treatment: 'Routine Checkup & Cleaning', doctor: 'Dr. Vance', status: 'Completed' },
  { id: 'APT-002', time: '10:30 AM', patient: 'Robert Kagawa', patientInitials: 'RK', clinic: 'Ocean Breeze Ortho', treatment: 'Root Canal Therapy', doctor: 'Dr. Aris', status: 'Confirmed' },
  { id: 'APT-003', time: '11:45 AM', patient: 'Elena Lopez', patientInitials: 'EL', clinic: 'Smile Center Austin', treatment: 'Wisdom Tooth Extraction', doctor: 'Dr. Vance', status: 'In-Progress' },
  { id: 'APT-004', time: '01:15 PM', patient: 'David Anderson', patientInitials: 'DA', clinic: 'Lakeside Vista Clinic', treatment: 'Crown Placement', doctor: 'Dr. Patel', status: 'Scheduled' },
  { id: 'APT-005', time: '02:30 PM', patient: 'Maria Lindqvist', patientInitials: 'ML', clinic: 'North Peak Dental', treatment: 'Dental Implant Consultation', doctor: 'Dr. Vance', status: 'Confirmed' },
  { id: 'APT-006', time: '03:45 PM', patient: 'James Thornton', patientInitials: 'JT', clinic: 'Ocean Breeze Ortho', treatment: 'Orthodontic Review', doctor: 'Dr. Aris', status: 'Cancelled' },
];
  ...
  return (
    <>
      <div className="mb-8 flex justify-between items-end">
        <div>
          <h2 className="text-4xl font-extrabold font-manrope tracking-tight text-on-surface mb-2">Appointment Scheduling</h2>
          <p className="text-on-surface-variant">Monitor and manage appointments across all tenant clinics.</p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-8">
        {[
          { label: 'Today Total', value: '48', icon: 'calendar_month', color: 'text-primary', bg: 'bg-primary/10' },
          { label: 'Completed', value: '22', icon: 'check_circle', color: 'text-secondary', bg: 'bg-secondary/10' },
          { label: 'In Progress', value: '8', icon: 'pending', color: 'text-tertiary', bg: 'bg-tertiary/10' },
          { label: 'Cancelled', value: '3', icon: 'cancel', color: 'text-error', bg: 'bg-error/10' },
        ].map(stat => (
      ...
      <section className="bg-surface-container-lowest rounded-xl overflow-hidden shadow-sm">
                ...
                <tr key={a.id} className="hover:bg-surface-container-low/30 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-full bg-primary/10 text-primary flex items-center justify-center font-bold text-sm">{a.patientInitials}</div>
                      <div>
                  ...
                  <td className="px-6 py-4">
                    <span className={`px-3 py-1 rounded-full text-xs font-bold ${statusStyle[a.status]}`}>{a.status}</span>
                  </td>
        ...
        <div className="p-6 bg-surface-container-low/20 flex justify-between items-center text-sm">
          <span className="text-on-surface-variant font-medium">Showing {filtered.length} appointments</span>
