        ...
        <div className="relative z-10 flex flex-col justify-between p-16 w-full h-full text-surface-container-lowest">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] uppercase tracking-widest font-bold leading-none mt-0.5 opacity-80 text-tertiary-container">Super Admin</p>
            </div>
          </div>
          
          <div className="max-w-md">
            <span className="inline-block px-4 py-1.5 mb-6 text-xs font-bold tracking-widest uppercase bg-white/10 backdrop-blur-md rounded-full border border-white/20 text-tertiary-container">Restricted Access</span>
            ...
            <p className="text-xl font-light leading-relaxed mb-10 opacity-90">
              Oversee multi-tenant architecture, manage global billing, and control infrastructure across 500+ clinics worldwide.
            </p>
            
            <div className="bg-black/20 backdrop-blur-md p-6 rounded-2xl border border-white/10 flex items-center gap-4">
              <span className="material-symbols-outlined text-tertiary-container text-3xl">public</span>
              <div>
      ...
      <section className="w-full lg:w-7/12 flex items-center justify-center p-8 relative">
        ...
        <div className="w-full max-w-md space-y-10 relative z-10">
          ...
          <div className="lg:hidden flex items-center gap-2 mb-12">
            <span className="material-symbols-outlined text-tertiary text-3xl" style={{ fontVariationSettings: "'FILL' 1" }}>shield</span>
            <h1 className="font-headline text-2xl font-extrabold text-on-surface tracking-tight">DentFlow Admin</h1>
          </div>

          <header>
            <h3 className="font-headline text-4xl font-bold text-on-surface mb-2 tracking-tight">System Login</h3>
            <p className="text-on-surface-variant text-lg">Authenticate to access the backend terminal.</p>
          </header>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-bold text-on-surface-variant" htmlFor="email">Admin ID (Email)</label>
              <div className="relative group">
                <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-outline/60 group-focus-within:text-tertiary transition-colors">admin_panel_settings</span>
                <input 
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <label className="block text-sm font-bold text-on-surface-variant" htmlFor="password">Security Key</label>
              </div>
              <div className="relative group">
                <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-outline/60 group-focus-within:text-tertiary transition-colors">lock</span>
                <input 
            ...
            <div className="flex items-center gap-3 pt-2 pb-4">
              <div className="relative flex items-center">
                <input className="w-5 h-5 text-tertiary bg-surface-container-lowest border-outline-variant/60 rounded focus:ring-tertiary/20 transition-all cursor-pointer peer appearance-none checked:bg-tertiary checked:border-tertiary" id="remember" type="checkbox" />
                <span className="material-symbols-outlined absolute left-0.5 top-0.5 text-white text-[16px] pointer-events-none opacity-0 peer-checked:opacity-100 transition-opacity">check</span>
              </div>
              <label className="text-sm text-on-surface-variant font-bold select-none cursor-pointer" htmlFor="remember">Trust this device</label>
            </div>
          ...
          <div className="mt-12 flex justify-center gap-6 text-sm font-semibold text-outline">
            <Link href="#" className="hover:text-on-surface-variant transition-colors">System Protocol</Link>
            <span className="w-1 h-1 rounded-full bg-outline-variant/50 self-center"></span>
            <Link href="#" className="hover:text-on-surface-variant transition-colors">Emergency Overlay</Link>
          </div>
        </div>
      </section>
    </main>
